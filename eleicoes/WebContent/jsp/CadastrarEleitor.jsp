...
<body>
	...
	<br>
	<br>
	<h1 align="center">Cadastrar Eleitor</h1>
	<div class="conteudo">
		<form action="/eleicoes/salvarEleitor" method="post">
			<label>Nome:<br> <input type="text" name="nome"></input>
			</label> <label><br> <br>CPF:<br> <input type="text"
				name="cpf"></input> </label> <label><br> <br>RG:<br>
				<input type="text" name="rg"></input> </label> <label><br> <br>Nome
				da mãe:<br> <input type="text" name="nome da mae"></input> </label> <label><br>
				<br>Naturalidade:<br> <input type="text"
				name="naturalidade"></input> </label> <label><br> <br>Data
				de Nascimento:<br> <input type="text" name="data"></input> </label> <label><br>
				<br>Número do Título:<br> <input type="text" name="titulo"></input>
			</label><br> <br>Estado Civil:<br> <br> <label
				for="solteiro"> <input type="radio" name="estado_civil"
				id="solteiro" value="SOLTEIRO"> Solteiro(a)
			</label><br> <label for="casado"> <input type="radio"
				name="estado_civil" id="casado" value="CASADO"> Casado(a)
			</label> <br>
			<br> <input type="submit"></input> <br> <input type="reset"
				value="Limpar Campos"></input>
		</form>
	</div>
</body>
</html>